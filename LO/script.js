...
document.getElementById('model_global').addEventListener('change', function() { updateDynamicMenu(); updateQR(); }); 
updateDynamicMenu(); 
updateQR(); 
updateStatusStempel();
